...
public class ModelSpecification<T> implements Specification<T> {
	...
	private Object convertValue(String value, Class type) {
		try {
			...
			throw new BadRequest${service.name.substring(0,1).toUpperCase()}${service.name.substring(1)}ServiceException("Unable to parse. Field value is in invalid format.", e);
		}
		return value;
	}
